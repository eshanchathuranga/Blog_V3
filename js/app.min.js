...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Eshan Chathuranga"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Eshan Chathuranga</td></tr>
					<tr><td>Profession</td><td>Web Developer</td></tr>
            ...
            <td>Contact</td>
            <td>
              <a href="mailto:eshanchathurangafdo@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href=" "><i class="fab fa-skype"></i></a>
              <a href=" "><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/eshanchathuranga" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="profile-image"><img src="${imagePath}/my-cat.jpg" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Unkoun</td></tr>
					<tr><td>Alias</td><td>User</td></tr>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://www.arter.fi/">Arter Oy</a></td><td>Helsinki, Finland</td><td>2023 - 2024</td><td><a href="#" onclick="modal(event)" data-title="Arter Oy">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://oivan.com/">Oivan</a></td><td>Helsingfors, Finland</td><td>2023 - 2024</td><td><a href="#" onclick="modal(event)" data-title="Oivan">Full Report</a></td></tr>
					<tr><td>Working from home</td><td>Remote</td><td>2023 - 2024</td><td><a href="#" onclick="modal(event)" data-title="Working from home">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  {
    ...
    html: `<table>
			<tbody>
				<tr>
          <td>Nebula Institute of Technology</td>
          <td>2024</td>
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>C#</td></tr>
				<tr><td>TypeScript</td><td>C++</td></tr>
